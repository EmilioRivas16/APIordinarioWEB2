...
<body>
    ...
    <div class="container">
        ...
        <a href="models/logout">Cerrar sesión</a>
        <br><br>
    ...
    <?php
        ...
        $api_url = 'http://localhost:84/API-ORDINARIO/models/get.php';
      ...
      <thead>
        ...
        ?>
            <tr id="fila-<?php echo ($data->id) ?>">
                ...
                <td>
                    <a href="form_update?id=<?php echo ($data->id)?>" class="btn btn-primary">Actualizar</a>
                    <a href="models/delete?id=<?php echo ($data->id)?>" class="btn btn-danger">Eliminar</a>
                </td>
            </tr>
        <?php
            }
